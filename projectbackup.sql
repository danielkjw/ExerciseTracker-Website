...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`kimdanieljw`@`%`*/ /*!50003 TRIGGER Before_Insert_Friend BEFORE INSERT ON `friendship`
FOR EACH ROW
BEGIN
  IF (EXISTS(SELECT 1 FROM `friendship` WHERE member1_id = NEW.member1_id AND member2_id = NEW.member2_id)
    OR EXISTS(SELECT 1 FROM `friendship` WHERE member1_id = NEW.member2_id AND member2_id = NEW.member1_id)) THEN
    SIGNAL SQLSTATE VALUE '45000' SET MESSAGE_TEXT = 'INSERT failed due to duplicate friendship number';
  ELSE
    SET new.friendship_key = CONCAT(new.member1_id,new.member2_id,'-',new.member2_id,new.member1_id);
  END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
INSERT INTO `log` VALUES (1,'2017-08-01',1),(2,'2018-08-10',1),(3,'2018-08-22',3),(4,'2018-07-22',4),(5,'2018-09-02',5),(6,'2018-10-03',6),(7,'2018-11-04',7),(8,'2018-12-05',2),(10,'2018-06-11',11),(11,'2018-06-18',13);
...
-- Dump completed on 2018-06-14  6:06:29
